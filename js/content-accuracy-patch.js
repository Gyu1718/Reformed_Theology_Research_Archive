...
(function () {
  ...
  patchTopic("covenant-theology", {
    summary: "그리스도 안의 하나님의 언약 목적에서 창조와 화해를 읽는 방식과, 이를 개혁파가 행위언약·은혜언약의 교리 체계로 전개하는 방식을 비교하는 주제.",
    diverge: "바르트는 창조와 화해를 그리스도 안의 하나님의 언약 목적에서 읽지만, 전통적 행위언약·은혜언약 체계로 전개하지는 않는다. 이에 비해 개혁파 정통은 언약을 창조·타락·구속을 연결하는 교의학적 구조 원리로 삼는다."
  });

  patchTopic("eschatology", {
    summary: "예수 그리스도의 부활과 화해 안에서 열린 미래의 약속, 그리고 죽음·부활·심판·새 창조를 다루는 주제.",
    diverge: "바르트는 종말을 예수 그리스도의 부활과 화해 안에서 이미 열린 미래의 약속으로 읽는다. 이에 비해 개혁파 정통은 개인 종말과 일반 종말을 구분해 재림, 부활, 심판, 최종 상태를 교리적으로 배열한다."
  });
