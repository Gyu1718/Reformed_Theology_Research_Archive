...
(function () {
  ...
  var MATRIX = [
    {
      ...
      priority: "바르트 관점에서는 성경을 닫힌 정보 저장소보다 하나님이 지금 말씀하시는 증언의 자리로 읽게 됩니다."
    },
    {
      locus: "자연신학",
      ...
      priority: "이 표에서는 바르트의 경고를 우선합니다. 자연과 문화는 신학의 출발점이 아니라 그리스도 안에서 다시 해석될 자료입니다."
    },
    {
      locus: "신론",
      ...
      priority: "바르트 관점에서는 속성 목록보다 하나님이 그리스도 안에서 자신을 어떻게 드러내셨는지가 해석의 중심입니다."
    },
    {
      locus: "예정론",
      ...
      priority: "바르트의 우선점은 예정론을 숨은 결정론이 아니라 예수 그리스도 안에서 드러난 은혜의 결정으로 읽게 하는 데 있습니다."
    },
    {
      locus: "인간과 죄",
      ...
      priority: "바르트 관점에서는 인간을 추상적 본성에서 출발해 정의하기보다 참 인간 예수 그리스도에게서 다시 배웁니다."
    },
    {
      locus: "기독론",
      ...
      priority: "이 홈페이지의 기본 방향은 바르트처럼 그리스도를 여러 교리 중 한 항목이 아니라 모든 교리의 중심 문법으로 읽는 것입니다."
    },
    {
      locus: "칭의와 구원",
      ...
      priority: "바르트 쪽으로 읽을 때 구원은 먼저 인간 내면의 단계가 아니라 그리스도 안에서 성취된 화해의 현실입니다."
    },
    {
      locus: "교회론",
      ...
      priority: "바르트 관점에서는 교회를 자기 보존의 제도보다 말씀을 듣고 증언하는 공동체로 우선 이해합니다."
    },
    {
      locus: "성례론",
      ...
      priority: "여기서는 바르트의 문제의식을 따라 성례를 자동적 장치가 아니라 그리스도의 선행 은혜에 대한 응답과 증언의 자리로 읽습니다."
    },
    {
      locus: "종말론",
      ...
      priority: "바르트적 독해는 종말을 공포의 시간표보다 그리스도 안에서 이미 열린 소망의 지평으로 보게 합니다."
    }
  ];
  ...
  function ensureStyles() {
    ...
    style.textContent = "\
      ...
      .matrix-table{width:100%;border-collapse:collapse;min-width:1120px;}\
      ...
      .matrix-table td.priority-cell{color:var(--neo-ink);background:rgba(240,226,223,.58);font-weight:500;}\
  ...
  function textPool(row) {
    return [row.locus, row.question, row.calvin, row.berkhof, row.bavinck, row.barth, row.priority].join(" ");
  }
  ...
  function renderRow(row) {
    return '<tr>' +
      ...
      '<td class="priority-cell">' + esc(row.priority) + '</td>' +
    '</tr>';
  }
  ...
  function renderMatrix() {
    ...
    var body = rows.length ? rows.map(renderRow).join("") : '<tr><td colspan="6">검색 조건에 맞는 비교 항목이 없습니다.</td></tr>';
    view.innerHTML = '<section class="matrix-wrap">' +
      '<div class="matrix-intro">' +
        ...
        '<p>개혁파 정통의 흐름을 충분히 배우되, 최종 해석의 무게는 바르트의 계시 중심·그리스도 중심 재구성에 둡니다. 이 표는 입문자가 네 신학자의 차이를 한눈에 비교하도록 만든 학습용 요약입니다.</p>' +
      '</div>' +
      '<div class="scholar-row">' + SCHOLARS.map(renderScholar).join("") + '</div>' +
      '<div class="matrix-table-wrap"><table class="matrix-table">' +
        '<thead><tr><th>교리 주제</th><th>칼빈</th><th>벌코프</th><th>바빙크</th><th>바르트</th><th>바르트 우선 독해</th></tr></thead>' +
        '<tbody>' + body + '</tbody>' +
      '</table></div>' +
    '</section>';
  }
