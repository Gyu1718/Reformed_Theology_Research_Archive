...
(function () {
  ...
  var DOCS = [
    {
      ...
      structure: [
        ["1–2항", "성부와 창조", "전능하신 아버지 하나님과 천지 창조를 고백합니다."],
        ["3–8항", "성자와 구속", "성육신, 고난, 죽음, 부활, 승천, 하나님 우편, 재림과 심판을 고백합니다."],
        ["9–12항", "성령과 성화", "성령, 거룩한 보편 교회, 성도의 교제, 죄 사함, 몸의 부활, 영생을 고백합니다."]
      ],
      details: [
        ["해설 초점", "사도신경은 단순한 암송문이 아니라 교회가 복음의 내용을 짧게 고백하는 신앙의 표지입니다."],
        ["하이델베르크와의 연결", "하이델베르크 22–25문은 사도신경을 믿음의 내용으로 제시하고, 이를 성부·성자·성령의 구원 경륜으로 나누어 설명합니다."],
        ["교육 포인트", "교리반에서는 12항 암송에서 멈추지 말고, 각 항목이 창조·구속·성화·교회·종말로 이어지는 구조를 보여 주는 것이 좋습니다."]
      ],
    ...
    },
    {
      ...
      structure: [
        ["성부", "창조주 하나님", "한 분 하나님, 전능하신 아버지, 하늘과 땅의 창조주를 고백합니다."],
        ["성자", "참 하나님이신 그리스도", "성자는 성부에게서 나신 분이며, 피조물이 아니라 성부와 동일 본질이심을 고백합니다."],
        ["성령", "주님이시며 생명을 주시는 분", "성령의 신성과 교회·세례·부활·영생의 소망을 고백합니다."]
      ],
      details: [
        ["신학적 기능", "니케아 신경은 예수 그리스도를 뛰어난 피조물이나 중간 존재로 낮추는 해석을 거부하고, 그분의 참된 신성을 보존합니다."],
        ["사도신경과의 관계", "사도신경이 복음의 골자를 간결하게 말한다면, 니케아 신경은 특히 성자와 성령의 신성을 더 정밀하게 고백합니다."],
        ["교육 포인트", "삼위일체 교육에서는 ‘동일 본질’, ‘참 하나님’, ‘성령의 신성’을 중심 개념으로 삼아야 합니다."]
      ],
    ...
    },
    {
      ...
      structure: [
        ["한 분 그리스도", "인격의 통일성", "예수 그리스도는 둘로 나뉜 두 주체가 아니라 한 인격이십니다."],
        ["두 본성", "참 하나님·참 사람", "신성과 인성은 혼합되거나 변하거나 나뉘거나 분리되지 않습니다."],
        ["중보자", "구원의 가능성", "그리스도는 하나님과 인간 사이의 참 중보자이시기에 참 하나님과 참 사람이어야 합니다."]
      ],
      details: [
        ["신학적 기능", "칼케돈은 그리스도의 신성을 약화시키는 길과 인성을 약화시키는 길을 동시에 막습니다."],
        ["개혁파 연결", "웨스트민스터와 하이델베르크의 중보자론은 칼케돈의 기독론적 경계 안에서 이해되어야 합니다."],
        ["교육 포인트", "‘한 인격 두 본성’은 추상 공식이 아니라, 구원자가 왜 우리를 대표할 수 있고 동시에 우리를 구원할 수 있는지를 설명하는 복음의 문법입니다."]
      ],
    ...
    },
    {
      ...
      structure: [
        ["삼위일체", "한 본질, 세 위격", "성부·성자·성령은 혼동되지 않고, 신적 본질은 나뉘지 않습니다."],
        ["동등성", "영광과 위엄", "세 위격은 영원성과 권능과 영광에서 동등하게 고백됩니다."],
        ["성육신", "참 하나님·참 사람", "그리스도는 신성과 인성을 지니시되 한 분 그리스도이십니다."]
      ],
      details: [
        ["신학적 기능", "삼위일체를 물질적 비유나 단순한 역할 변화로 설명하는 오류를 막는 데 유용합니다."],
        ["교육적 주의", "초신자 교육에서는 표현이 무겁게 느껴질 수 있으므로, 니케아와 칼케돈을 먼저 설명한 뒤 보충 문서로 다루는 편이 좋습니다."],
        ["개념비교 연결", "삼위일체, 계시론, 기독론, 예배론 항목과 직접 연결됩니다."]
      ],
    ...
    },
    {
      ...
      structure: [
        ["1장", "성경", "계시, 정경, 영감, 권위, 명료성, 해석 원리."],
        ["2–5장", "하나님과 사역", "하나님, 삼위일체, 작정, 창조, 섭리."],
        ["6–8장", "죄·언약·중보자", "타락과 언약 구조, 그리스도의 중보 사역."],
        ["9–18장", "구원의 적용", "자유의지, 부르심, 칭의, 양자, 성화, 믿음, 회개, 선행, 견인."],
        ["19–33장", "교회와 삶과 종말", "법, 예배, 교회, 성례, 권징, 시민 정부, 죽음과 심판."]
      ],
      details: [
        ["교의학적 기능", "소요리문답이 교육용 압축이라면, 신앙고백서는 논쟁 가능한 교리 항목을 장별 명제로 정리한 표준문서 역할을 합니다."],
        ["비교축", "성경론, 작정, 언약, 칭의, 성화, 교회론, 성례론, 종말론의 개혁파 기준점으로 삼을 수 있습니다."],
        ["교육 포인트", "1장 성경론에서 시작해 하나님과 사역, 구원, 교회와 종말로 이어지는 흐름을 먼저 보여 주는 것이 좋습니다."]
      ],
    ...
    },
    {
      ...
      structure: [
        ["문 1–3", "목적과 성경", "인간의 제일 되는 목적, 성경의 가르침, 신앙과 의무."],
        ["문 4–38", "믿을 것", "하나님, 작정, 창조, 섭리, 타락, 은혜 언약, 그리스도, 구속 적용."],
        ["문 39–81", "행할 것", "도덕법과 십계명."],
        ["문 82–107", "은혜의 방편", "믿음과 회개, 말씀·성례·기도, 주기도문."]
      ],
      details: [
        ["해설서 기반 구조", "토머스 왓슨의 해설은 짧은 문답을 설교 가능한 교리 단락으로 풀어내며, 인간의 목적에서 시작해 구원 적용과 은혜의 방편으로 나아갑니다."],
        ["교리적 강점", "목적-규범-하나님-죄-그리스도-구원 적용-법-은혜의 방편의 구조가 조직신학 입문에 매우 적합합니다."],
        ["교육 포인트", "1문은 목적론, 33–35문은 칭의·양자·성화, 88문 이후는 은혜의 방편 훈련으로 카드화하기 좋습니다."]
      ],
    ...
    },
    {
      ...
      structure: [
        ["문 1–2", "유일한 위로", "나의 비참, 구원, 감사의 구조."],
        ["문 3–11", "죄와 비참", "율법을 통해 인간의 죄를 드러냅니다."],
        ["문 12–85", "구원", "중보자, 믿음, 사도신경, 칭의, 성례, 권징."],
        ["문 86–129", "감사", "선행, 회개, 십계명, 주기도문."]
      ],
      details: [
        ["해설서 기반 구조", "우르시누스는 율법과 복음의 큰 구조 안에서 요리문답을 설명하면서도, 교육 구조는 비참·구원·감사의 세 부분으로 전개합니다."],
        ["사도신경과의 연결", "22문부터 믿음의 내용을 사도신경으로 요약하고, 24–25문에서 이를 성부·성자·성령 구조로 나눕니다."],
        ["교육 포인트", "정답 암기보다 나의 위로와 감사의 삶을 강조하는 교육에 적합합니다."]
      ],
      features: ["목회적 문체", "위로", "죄-구원-감사", "사도신경 해설"],
    ...
    },
    {
      ...
      structure: [
        ["1–7조", "하나님과 성경", "하나님 인식, 계시, 정경과 성경의 충족성."],
        ["8–13조", "삼위일체·창조·섭리", "삼위일체와 창조, 섭리, 천사와 악의 문제."],
        ["14–26조", "인간·그리스도·구원", "타락, 원죄, 선택, 성육신, 만족, 칭의, 중보."],
        ["27–35조", "교회와 성례", "보편 교회, 참 교회 표지, 직분, 세례와 성찬."],
        ["36–37조", "국가와 종말", "시민 정부와 최후 심판."]
      ],
      details: [
        ["신앙고백적 성격", "개혁교회가 공교회적 기독교와 단절된 집단이 아니라는 점을 드러내는 변증적 문서입니다."],
        ["교회론 강점", "참 교회의 표지, 직분, 권징, 세례와 성찬을 연결해 읽기 좋습니다."],
        ["교육 포인트", "성경의 충족성, 참 교회, 성례, 시민 정부 항목은 현대 교회 현실과 연결해 토론하기 좋습니다."]
      ],
    ...
    },
    {
      ...
      structure: [
        ["제1교리", "선택과 유기", "구원의 궁극 근거가 하나님의 은혜로운 선택에 있음을 밝힙니다."],
        ["제2교리", "그리스도의 죽음", "속죄의 충분성과 구원 효력을 구분해 설명합니다."],
        ["제3·4교리", "부패와 회심", "전적 부패와 효과적 은혜, 성령의 내적 사역을 다룹니다."],
        ["제5교리", "성도의 견인", "참 신자가 하나님의 보존하심으로 믿음 안에 견딤을 설명합니다."]
      ],
      details: [
        ["논쟁사적 기능", "교의학 전체 요약이라기보다 구원론 논쟁에 대한 정밀한 응답입니다."],
        ["교리적 강점", "구원의 원인을 인간의 예견된 믿음이나 의지에서 찾지 않고 하나님의 은혜로운 선택과 성령의 효과적 사역에서 찾습니다."],
        ["교육 포인트", "TULIP 약어만 가르치기보다 각 교리가 왜 신자에게 위로가 되는지 묻는 카드로 만드는 편이 좋습니다."]
      ],
  ...
  function appendCount() {
    ...
    bar.insertAdjacentHTML("beforeend", '<span class="sep conf-count">·</span><b class="conf-count">' + DOCS.length + '</b><span class="conf-count"> 고백·문답</span><span class="sep conf-count">·</span><b class="conf-count">' + CARDS.length + '</b><span class="conf-count"> 카드</span>');
  }
